# -*- coding: utf-8 -*-
"""normalize_cat_27_breed.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1mEsIy5J56UyeApLNIFv7g-HCAukUMfgr
"""
...
final_mean_lst[:]=[x/81 for x in final_mean_lst]
print(final_mean_lst)

final_std_lst=[sum(i) for i in zip(*std_lst)]
final_std_lst[:]=[x/81 for x in final_std_lst]
print(final_std_lst)
