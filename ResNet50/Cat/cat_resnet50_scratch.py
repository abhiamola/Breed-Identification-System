# -*- coding: utf-8 -*-
"""cat-resnet50-scratch.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1AF-RmPlwhLtOW65R9FrTfDYtNPV9It81
"""
...
model, history = train_loop(
    ...
    trainloader,
    validloader,
    save_model_name="./resnet50_cat_scratch.pt",
    max_epochs_stop=10,
    num_epochs=30,
    num_epochs_report=1)
...
torch.save(model,"resnet50_cat_scratch.pb")

fetch_model=torch.load('../input/resnet50/resnet50_cat_scratch.pb')
