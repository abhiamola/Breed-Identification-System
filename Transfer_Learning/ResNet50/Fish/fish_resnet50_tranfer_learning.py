# -*- coding: utf-8 -*-
"""fish-resnet50-scratch.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1T5lQvVDpjJsXhBMd_QB5ZfCG7nMrdEBt
"""
...
model, history = train_loop(
    ...
    trainloader,
    validloader,
    save_model_name="./resnet50_fish_scratch.pt",
    max_epochs_stop=10,
    num_epochs=30,
    num_epochs_report=3)
...
import requests
from io import BytesIO
url = "https://santamonicaseafood.com/wp-content/uploads/2020/10/SNA171-21.2.jpg"
...
torch.save(model,"resnet50_fish_scratch.pb")

fetch_model=torch.load('../input/resnet50/resnet50_fish_scratch.pb')
...
plt.savefig('./confusion_resnet50.png')
